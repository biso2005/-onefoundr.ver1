...
export default function LeveragePlaceholder({
  title,
  description,
  track,
  trackLabel,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#1A1A1A] text-white py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-500 to-rose-500 text-white text-sm font-medium mb-6">
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-10 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gray-100 mb-6">
              <Anchor className="w-7 h-7 text-gray-500" />
            </div>
