...
export const metadata: Metadata = {
  title: 'Tax Planning — OneFoundr',
  description: 'Minimize your tax burden through strategic planning, proper deductions, and quarterly tax preparation.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#1A1A1A] text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Page Title */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Tax Planning</h1>

          {/* Description */}
          <p className="text-xl text-gray-300 max-w-3xl">Minimize your tax burden through strategic planning, proper deductions, and quarterly tax preparation.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're crafting an in-depth guide on tax planning and optimization for solo founders. Want to be notified when it's ready? Join our newsletter for updates and early access to new content.</p>
