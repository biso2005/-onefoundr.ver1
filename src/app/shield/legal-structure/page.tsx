...
export const metadata: Metadata = {
  title: 'Legal Structure — OneFoundr',
  description: 'Choose the right legal entity for your business — LLC, S-Corp, sole proprietorship, and the tax and liability implications of each.',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#1A1A1A] text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Page Title */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Legal Structure</h1>

          {/* Description */}
          <p className="text-xl text-gray-300 max-w-3xl">Choose the right legal entity for your business — LLC, S-Corp, sole proprietorship, and the tax and liability implications of each.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're crafting an in-depth guide on choosing your business legal structure. Want to be notified when it's ready? Join our newsletter for updates and early access to new content.</p>
