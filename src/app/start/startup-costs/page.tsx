...
export const metadata: Metadata = {
  title: 'Startup Costs — OneFoundr',
  description: 'Estimating and minimising startup costs for solo founders.',
}
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#1A1A1A] text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Startup Costs & Budgeting</h1>
          <p className="text-xl text-gray-300 max-w-3xl">Estimate the essential costs and build a lean budget for your first product or service.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're compiling practical spreadsheets and cost-reduction tips. Join the newsletter to get notified.</p>
