    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#1A1A1A] text-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Productized Services</h1>
          <p className="text-xl text-gray-300 max-w-3xl">Turn your services into repeatable packages with clear outcomes and delivery scope.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">Practical scopes, deliverable checklists, and pricing templates to productize your services.</p>
