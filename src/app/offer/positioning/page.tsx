...
export const metadata: Metadata = {
  title: 'Positioning — OneFoundr',
  description: 'Position your offer in the market to stand out from competitors and attract your ideal customers willing to pay premium prices.',
}
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#1A1A1A] text-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Positioning</h1>

          <p className="text-xl text-gray-300 max-w-3xl">Position your offer in the market to stand out from competitors and attract your ideal customers willing to pay premium prices.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're crafting an in-depth guide on market positioning and differentiation. Want to be notified when it's ready? Join our newsletter for updates and early access to new content.</p>
