...
export const metadata: Metadata = {
  title: 'Recurring Revenue — OneFoundr',
  description: 'Build predictable monthly income through subscriptions, retainers, and recurring service models.',
}
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#1A1A1A] text-white py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 max-w-3xl">Build predictable monthly income through subscriptions, retainers, and recurring service models.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're crafting an in-depth guide on building recurring revenue streams. Want to be notified when it's ready? Join our newsletter for updates and early access to new content.</p>
