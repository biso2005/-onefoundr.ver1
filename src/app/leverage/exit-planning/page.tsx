...
export const metadata: Metadata = {
  title: 'Exit Planning — OneFoundr',
  description: 'Prepare your business for acquisition or sale — building sellable assets, documentation, and enterprise value.',
}
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-[#1A1A1A] text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Exit Planning</h1>

          <p className="text-xl text-gray-300 max-w-3xl">Prepare your business for acquisition or sale — building sellable assets, documentation, and enterprise value.</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">We're crafting an in-depth guide on planning your business exit. Want to be notified when it's ready? Join our newsletter for updates and early access to new content.</p>
